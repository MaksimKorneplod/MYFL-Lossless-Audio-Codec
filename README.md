...
![Рис. 1 — Пример вывода в консоль при кодировании](image/image2.png)

![Рис. 2 — Результат сжатия](image/image3.png)

![Рис. 3 — Спектрограммы оригинального и декодированного файла](image/image4.png)

![Рис. 4 — Демонстрация полученных файлов](image/image5.png)
...
![Рис. 5 — Спектрограммы синусоидального файла](image/image6.png)
...
![Рис. 6 — Спектрограммы транзиент аудио-файла](image/image7.png)
...
![Рис. 7 — Спектрограммы эмбиент аудио-файла](image/image8.png)
...
![Рис. 8 — Спектрограммы поп-трека](image/image9.png)
